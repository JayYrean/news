<template>
	<div class="news" id="announcementnews">
...
export default {
	...
	created: function () {
		this.dataArr = JSON.parse(this.$route.query.hotList);	//获取通过路由传过来的hotList数组
	},
	computed: {
		List: function () {
	...
	methods: {
		compare: function(property){	//同navResult的compare利用闭包进行对 对象 的某个特性的排序
			return function(a,b){
				var result = -1;
